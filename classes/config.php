...
class config {
     ...
     * nothing.
     *
     * Seeded by db/install.php on a fresh install and by the 2026080306 upgrade
     * block on an existing one. Both only ever write a key that is absent, so a
     * value an administrator or the control plane chose is never touched.
     *
